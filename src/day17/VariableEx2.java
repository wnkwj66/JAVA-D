...
//		멤버변수(클래스,객체) : 의미있는 정보를 클래스 안에 선언 할 때 사용하는 변수.
//							해당 정보가 메서드 곳곳에 쓰일 때
//		지역변수 : 메서드를 실행하는데 있어서 자체적으로 사용하는 변수 , 외부에서 알려주는 정보와 상관없음.
//		매개변수 : 메서드에서 실행하는데 있어 필요한 정보
//				메서드 안에서 매개변수 = 값; 과 같은 코드가 발생한다면 해당 매개변수는 
//				지역변수로 바꿔도 되는 매개변수이다.
